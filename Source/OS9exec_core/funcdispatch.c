...
ulong
    sum_slp_idleticks; /* total number of ticks spent idle (arbitrate sleep) */
...
const funcdispatch_entry invalidcall = {/* invalid */ OS9_F_UnImp, "---", 0, 0};

const funcdispatch_entry nocall = {/* no call */ OS9_F_SDummy, "<none>", 0, 0};

const funcdispatch_entry tcpselect = {/* $61     */ OS9_TCP_Select,
                                      "OS9_TCP_Select",
                                      0,
                                      0}; /* OS9TCP specific call */

const funcdispatch_entry fcalltable[NUMFCALLS] = {
    {/* 0x00 */ OS9_F_Link,
     "F$Link",
     d_w(0) + a_p(0),
     d_w(0) + d_w(1) + a_l(0) + a_l(1) + a_l(2)}, /* Link to Module */
    {/* 0x01 */ OS9_F_Load,
     "F$Load",
     d_b(0) + a_p(0),
     d_w(0) + d_w(1) + a_l(0) + a_l(1) + a_l(2)}, /* Load Module from File */
    {/* 0x02 */ OS9_F_UnLink, "F$UnLink", a_l(2), 0}, /* Unlink Module */
    {/* 0x03 */ OS9_F_Fork,
     "F$Fork",
     d_w(0) + d_l(1) + d_l(2) + d_w(3) + d_w(4) + a_p(0) + a_l(1),
     d_w(0) + a_l(0)}, /* Start New Process */
    {/* 0x04 */ OS9_F_Wait,
     "F$Wait",
     0,
     d_w(0) + d_w(1)}, /* Wait for Child Process to Die */
    {/* 0x05 */ OS9_F_Chain,
     "F$Chain",
     d_w(0) + d_l(1) + d_l(2) + d_w(3) + d_w(4) + a_p(0) + a_l(1),
     0}, /* Chain Process to New Module */
    {/* 0x06 */ OS9_F_Exit, "F$Exit", d_w(1), 0}, /* Terminate Process */
    {/* 0x07 */ OS9_F_UnImp,
     "F$Mem",
     d_l(0),
     d_l(0) + a_l(1)}, /* Set Memory Size */
    {/* 0x08 */ OS9_F_Send,
     "F$Send",
     d_w(0) + d_w(1),
     0}, /* Send Signal to Process */
    {/* 0x09 */ OS9_F_Icpt,
     "F$Icpt",
     a_l(0) + a_l(6),
     0}, /* Set Signal Intercept */
    {/* 0x0A */ OS9_F_Sleep, "F$Sleep", d_l(0), d_l(0)}, /* Suspend Process */
    {/* 0x0B */ OS9_F_UnImp, "F$SSpd", d_w(0), d_w(1)},  /* Suspend Process */
    {/* 0x0C */ OS9_F_ID,
     "F$ID",
     0,
     d_w(0) + d_l(1) + d_w(2)}, /* Return Process ID */
    {/* 0x0D */ OS9_F_SPrior,
     "F$SPrior",
     d_w(0) + d_w(1),
    ...
    {/* 0x0E */ OS9_F_STrap,
     "F$STrap",
     a_l(0) + a_l(1),
     0}, /* Set Trap Intercept */
    {/* 0x0F */ OS9_F_PErr, "F$PErr", d_w(0) + d_w(1), 0}, /* Print Error */
    {/* 0x10 */ OS9_F_PrsNam,
     "F$PrsNam",
     a_p(0),
     d_b(0) + d_w(1) + a_l(0) + a_l(1)}, /* Parse Pathlist Name */
    {/* 0x11 */ OS9_F_CmpNam,
     "F$CmpNam",
     d_w(1) + a_p(0) + a_p(1),
     0},                                                  /* Compare Two Name */
    ...
    {/* 0x13 */ OS9_F_UnImp,
     "F$AllBit",
     d_w(0),
     d_w(1)}, /* Allocate in Bit Map */
    {/* 0x14 */ OS9_F_UnImp,
     "F$DelBit",
     d_w(0),
     d_w(1)}, /* Deallocate in Bit Map */
    {/* 0x15 */ OS9_F_Time,
     "F$Time",
     d_w(0),
     d_l(0) + d_l(1) + d_w(2) + d_l(3)}, /* Get Current Time */
    {/* 0x16 */ OS9_F_STime,
     "F$STime",
     d_l(0) + d_l(1),
     0}, /* Set Current Time */
    ...
    {/* 0x18 */ OS9_F_GPrDsc,
     "F$GPrDsc",
     d_w(0) + d_w(1) + a_l(0),
     0}, /* get Process Descriptor copy */
    {/* 0x19 */ OS9_F_GBlkMp,
     "F$GBlkMp",
     d_w(0) + d_w(1) + a_l(0),
     d_l(0) + d_l(1) + d_l(2) + d_l(3) +
         a_l(0)}, /* get System Block Map copy */
    {/* 0x1A */ OS9_F_GModDr,
     "F$GModDr",
     d_l(1) + a_l(0),
     d_l(1)}, /* get Module Directory copy */
    {/* 0x1B */ OS9_F_CpyMem,
     "F$CpyMem",
     d_w(0) + d_l(1) + a_l(0) + a_l(1),
     0},                                            /* Copy External Memory */
    {/* 0x1C */ OS9_F_SUser, "F$SUser", d_l(1), 0}, /* Set User ID number */
    {/* 0x1D */ OS9_F_UnLoad,
     "F$UnLoad",
     d_w(0) + a_p(0),
     a_l(0)},                              /* Unlink Module by name */
    {/* 0x1E */ OS9_F_RTE, "F$RTE", 0, 0}, /* Return from Intercept routine */
    {/* 0x1F */ OS9_F_GPrDBT,
     "F$GPrDBT",
     a_l(0) + d_l(1),
     d_l(1)}, /* Get system global data copy */
    {/* 0x20 */ OS9_F_Julian,
     "F$Julian",
     d_l(0) + d_l(1),
     d_l(0) + d_l(1)}, /* Convert gregorian to Julian date */
    {/* 0x21 */ OS9_F_TLink,
     "F$TLink",
     d_w(0) + d_l(1) + a_p(0),
     a_l(0) + a_l(1) + a_l(2)}, /* Link trap subroutine package */
    {/* 0x22 */ OS9_F_UnImp,
     "F$DFork",
     d_w(0),
     d_w(1)}, /* Debugging Fork call */
    {/* 0x23 */ OS9_F_UnImp,
     "F$DExec",
     d_w(0),
     d_w(1)}, /* Debugging execution call (single step) */
    {/* 0x24 */ OS9_F_UnImp,
     "F$DExit",
     d_w(0),
     d_w(1)}, /* Debugging exit call (kill child) */
    {/* 0x25 */ OS9_F_DatMod,
     "F$DatMod",
     d_l(0) + d_w(1) + d_w(2) + d_w(3) + a_p(0),
     d_w(0) + d_w(1) + a_l(0) + a_l(1) + a_l(2)}, /* Create data module */
    {/* 0x26 */ OS9_F_SetCRC,
     "F$SetCRC",
     a_l(0),
     0}, /* Generate valid header and CRC in module */
    {/* 0x27 */ OS9_F_SetSys,
     "F$SetSys",
     d_w(0) + d_l(1) + d_l(2),
     d_l(2)}, /* Set/examine system global variable */
    {/* 0x28 */ OS9_F_SRqMem,
     "F$SRqMem",
     d_l(0),
     d_l(0) + a_l(2)}, /* System Memory Request */
    {/* 0x29 */ OS9_F_SRtMem,
     "F$SRtMem",
     d_l(0) + a_l(2),
     0}, /* System Memory Return */
    {/* 0x2A */ OS9_F_UnImp,
     "F$IRQ",
     d_w(0),
     d_w(1)}, /* Enter IRQ Polling Table */
    {/* 0x2B */ OS9_F_UnImp, "F$IOQu", d_w(0), d_w(1)}, /* Enter I/O Queue */
    {/* 0x2C */ OS9_F_UnImp,
     "F$AProc",
     d_w(0),
     d_w(1)}, /* Enter Active Process Queue */
    {/* 0x2D */ OS9_F_UnImp,
     "F$NProc",
     d_w(0),
     d_w(1)}, /* Start Next Process */
    {/* 0x2E */ OS9_F_UnImp, "F$VModul", d_w(0), d_w(1)}, /* Validate Module */
    {/* 0x2F */ OS9_F_UnImp,
     "F$FindPD",
     d_w(0),
     d_w(1)}, /* Find Process/Path Descriptor */
    {/* 0x30 */ OS9_F_UnImp,
     "F$AllPD",
     d_w(0),
     d_w(1)}, /* Allocate Process/Path Descriptor */
    {/* 0x31 */ OS9_F_UnImp,
     "F$RetPD",
     d_w(0),
     d_w(1)}, /* Return Process/Path Descriptor */
    {/* 0x32 */ OS9_F_SSvc,
     "F$SSvc",
     a_l(1) + a_l(3),
     0}, /* Service Request Table Initialization */
    ...
    {/* 0x39 */ OS9_F_UnImp,
     "F$AllRAM",
     d_w(0),
     d_w(1)}, /* Allocate RAM blocks */
    {/* 0x3A */ OS9_F_Permit,
     "F$Permit",
     d_l(0) + d_b(1) + a_l(2),
     d_w(1)}, /* Protect access to RAM block */
    {/* 0x3B */ OS9_F_UnImp,
     "F$Protect",
     d_w(0),
     d_w(1)}, /* Protect access of RAM block */
    {/* 0x3C */ OS9_F_UnImp,
     "F$SetImg",
     d_w(0),
     d_w(1)}, /* Set Process DAT Image */
    {/* 0x3D */ OS9_F_UnImp,
     "F$FreeLB",
     d_w(0),
     d_w(1)}, /* Get Free Low Block */
    {/* 0x3E */ OS9_F_UnImp,
     "F$FreeHB",
     d_w(0),
     d_w(1)}, /* Get Free High Block */
    {/* 0x3F */ OS9_F_UnImp,
     "F$AllTsk",
     d_w(0),
     d_w(1)}, /* Allocate Process Task number */
    {/* 0x40 */ OS9_F_UnImp,
     "F$DelTsk",
     d_w(0),
     d_w(1)}, /* Deallocate Process Task number */
    {/* 0x41 */ OS9_F_UnImp,
     "F$SetTsk",
     d_w(0),
     d_w(1)}, /* Set Process Task DAT registers */
    {/* 0x42 */ OS9_F_UnImp,
     "F$ResTsk",
     d_w(0),
     d_w(1)}, /* Reserve Task number */
    {/* 0x43 */ OS9_F_UnImp,
     "F$RelTsk",
     d_w(0),
     d_w(1)}, /* Release Task number */
    {/* 0x44 */ OS9_F_UnImp,
     "F$DATLog",
     d_w(0),
     d_w(1)}, /* Convert DAT Block/Offset to Logical */
    {/* 0x45 */ OS9_F_UnImp,
     "F$DATTmp",
     d_w(0),
     d_w(1)}, /* Make temporary DAT image */
    ...
    {/* 0x49 */ OS9_F_UnImp,
     "F$LDABX",
     d_w(0),
     d_w(1)}, /* Load A from 0,X in task B */
    {/* 0x4A */ OS9_F_UnImp,
     "F$STABX",
     d_w(0),
     d_w(1)}, /* Store A at 0,X in task B */
    {/* 0x4B */ OS9_F_UnImp,
     "F$AllPrc",
     d_w(0),
     d_w(1)}, /* Allocate Process Descriptor */
    {/* 0x4C */ OS9_F_UnImp,
     "F$DelPrc",
     d_w(0),
     d_w(1)}, /* Deallocate Process Descriptor */
    {/* 0x4D */ OS9_F_UnImp,
     "F$ELink",
     d_w(0),
     d_w(1)}, /* Link using Module Directory Entry */
    {/* 0x4E */ OS9_F_UnImp,
     "F$FModul",
     d_w(0),
     d_w(1)}, /* Find Module Directory Entry */
    {/* 0x4F */ OS9_F_UnImp,
     "F$MapBlk",
     d_w(0),
     d_w(1)}, /* Map Specific Block */
    {/* 0x50 */ OS9_F_UnImp,
     "F$ClrBlk",
     d_w(0),
     d_w(1)}, /* Clear Specific Block */
    {/* 0x51 */ OS9_F_UnImp,
     "F$DelRAM",
     d_w(0),
     d_w(1)}, /* Deallocate RAM blocks */
    {/* 0x52 */ OS9_F_SysDbg,
     "F$SysDbg",
     0,
     0}, /* Invoke system level debugger */
    {/* 0x53 */ OS9_F_Event,
     "F$Event",
     SEVENT_CALL + d_l(0) + d_w(1) + d_w(2) + d_w(3) + a_l(0),
     d_l(0) + a_l(0)}, /* Create/Link to named event */
    {/* 0x54 */ OS9_F_Gregor,
     "F$Gregor",
     d_l(0) + d_l(1),
     d_l(0) + d_l(1)}, /* Convert julian date to gregorian date */
    {/* 0x55 */ OS9_F_UnImp,
     "F$SysID",
     d_w(0),
     d_w(1)}, /* return system identification */
    {/* 0x56 */ OS9_F_Alarm,
     "F$Alarm",
     d_l(0) + d_w(1) + d_l(2) + d_l(3) + d_l(4),
     d_l(0)}, /* send alarm signal */
    {/* 0x57 */ OS9_F_Sigmask,
     "F$Sigmask",
     d_l(0) + d_l(1),
     0}, /* set signal mask */
    {/* 0x58 */ OS9_F_UnImp,
     "F$ChkMem",
     d_w(0),
     d_w(1)}, /* determine if user process may access memory area */
    {/* 0x59 */ OS9_F_UnImp,
     "F$UAcct",
     d_w(0),
     d_w(1)}, /* inform user accounting of process status */
    {/* 0x5A */ OS9_F_SDummy, "F$CCtl", d_l(0), 0}, /* cache control */
    {/* 0x5B */ OS9_F_SUnImp,
     "F$GSPUMp",
     d_w(0),
     d_w(1)}, /* get SPU map information for a process */
    {/* 0x5C */ OS9_F_SRqMem,
     "F$SRqCMem",
     d_l(0) + d_l(1),
     d_l(0) + a_l(2)}, /* System Colored Memory Request */
    {/* 0x5D */ OS9_F_UnImp,
     "F$POSK",
     d_w(0),
     d_w(1)}, /* execute svc request */
...
const funcdispatch_entry icalltable[NUMICALLS] = {
    {/* 0x80 */ OS9_I_Attach,
     "I$Attach",
     d_b(0) + a_p(0),
     a_l(2)},                                         /* Attach I/O Device */
    {/* 0x81 */ OS9_I_Detach, "I$Detach", a_l(2), 0}, /* Detach I/O Device */
    {/* 0x82 */ OS9_I_Dup, "I$Dup", d_w(0), d_w(0)},  /* Duplicate Path */
    {/* 0x83 */ OS9_I_Create,
     "I$Create",
     d_b(0) + d_w(1) + d_l(2) + a_p(0),
     d_w(0) + a_l(0)}, /* Create New File */
    {/* 0x84 */ OS9_I_Open,
     "I$Open",
     d_b(0) + a_p(0),
     d_w(0) + a_l(0)}, /* Open Existing File */
    {/* 0x85 */ OS9_I_MakDir,
     "I$MakDir",
     d_b(0) + d_w(1) + d_l(2) + a_p(0),
     a_l(0)}, /* Make Directory File */
    {/* 0x86 */ OS9_I_ChgDir,
     "I$ChgDir",
     d_b(0) + a_p(0),
     a_l(0)}, /* Change Default Directory */
    {/* 0x87 */ OS9_I_Delete,
     "I$Delete",
     d_b(0) + a_p(0),
     a_l(0)}, /* Delete File */
    ...
    {/* 0x8B */ OS9_I_ReadLn,
     "I$ReadLn",
     d_w(0) + d_l(1) + a_l(0),
     d_l(1)}, /* Read Line of ASCII Data */
    {/* 0x8C */ OS9_I_WritLn,
     "I$WritLn",
     d_w(0) + d_l(1) + a_l(0),
     d_l(1)}, /* Write Line of ASCII Data */

    {/* 0x8D */ OS9_I_GetStt,
     "I$GetStt",
     SFUNC_STATCALL + d_w(0) + d_w(1) + d_l(2) + d_l(3) + a_l(0),
     d_l(0) + d_l(1) + d_l(2) + d_l(3) + a_l(0)}, /* Get Path Status */
    {/* 0x8E */ OS9_I_SetStt,
     "I$SetStt",
     SFUNC_STATCALL + d_w(0) + d_w(1) + d_l(2) + d_l(3) + a_l(0),
     d_l(0) + d_l(1) + d_l(2) + d_l(3) + a_l(0)}, /* Set Path Status */
...
const funcdispatch_entry *getfuncentry(ushort func)
{
    if (func == STARTCALL)
        return &startcall;
    if (func < NUMFCALLS)
        return &fcalltable[func];
    else {
        if (func >= ICALLS_Offs) {
            if (func - ICALLS_Offs < NUMICALLS)
                return &icalltable[func - ICALLS_Offs];
            else
                return &invalidcall; /* any other: invalid call */
        }
        else {
            if (func == 0x7F)
                return &nocall; /* consider this as "no call" */
            if (func == 0x61)
                return &tcpselect; /* this is used as selector in OS9TCP */
...
/* get the difference since last ticks */
{
    ...
    sum_rw__idleticks += rw__idleticks;
    rw__idleticks = 0;
    sum_slp_idleticks += slp_idleticks;
    slp_idleticks = 0;
...
/* Get systime ticks on the way from OS-9 to XXX command */
{
    ...
    systime_prog_ok =
        (*systime_prog == NUL) || (ustrcmp(systime_prog, mn) == 0);
    ...
    for (ii = 0; ii < MAX_OS9PROGS; ii++) {
        ...
        if (*s->name == NUL /* not yet in the list */
            ...
            while (kk < MAX_OS9PROGS - 1 && *statistics[kk].name != NUL)
                kk++;
...
void debug_comein(regs_type *rp, ushort pid)
{
    ...
    if (!Dbg_SysCall(rp, pid))
        return;
    if (cp->state == pWaitRead)
        return; /* avoid dbg display in pWaitRead mode */
...
void debug_return(regs_type *crp, ushort pid, Boolean cwti)
{
    ...
    if (cwti) {
        ...
        if ((cp->state ==
                 pActive || // internal utilities can be active now as well
             cp->oerr) &&
            cp->state != pWaitRead) { /* avoid dbg display in pWaitRead mode */

            /* D1.w/carry error reporting will be done when process is active or
             * syscall delivered error, */
            /* otherwise, d1.w will be updated when suspended process gets
             * active again */
...
/* perform system call */
os9err
exec_syscall(ushort func, ushort pid, regs_type *rp, Boolean withinIntUtil)
{
    // os9err  err;
    process_typ              *cp   = &procs[pid];
    procid                   *pd   = &cp->pd;
    const funcdispatch_entry *fdeP = getfuncentry(func);
    char *fName = fdeP->name; /* allows much easier debugging, because function
                                 name is visible */
    char *fSS = "";
    ...
    if (fdeP != &invalidcall) {
        if (func < NUMFCALLS)
            os9_long_inc(&pd->_fcalls, 1); /* "procs -a" uses it */
        else {
            func -= 0x80;
            if (func < NUMICALLS)
...
void init_syscalltimers(void)
{
    ...
    for (k = 0; k <= NUMFCALLS; k++) {
        fcall_time[k] = 0;
        fcall_num[k]  = 0;
    }
    for (k = 0; k <= NUMICALLS; k++) {
        icall_time[k] = 0;
        icall_num[k]  = 0;
    }
...
#define GLim 1
    ...
    if (active == 0)
        f = 0; /* no division by zero */
    else
        f = (float)100 * t / active;

    if ((mode & STIM_TICKAVAIL) && t < ticksLim)
        return;
    if ((mode & STIM_PERCENT) && f < GLim)
        return;
...
static void show_syscalltimers(Boolean icalls,
                               ushort  mode,
                               ulong   active,
                               ulong  *call,
                               ulong  *num,
                               int     ticksLim)
{
    ...
    *num  = 0;
    ...
    for (k = 0; k <= max; k++) {
        ...
        if (kInd == max)
            name = icalls ? "I$xxx (other progs)" : "F$xxx (other progs)";
        else
            name = icalls ? icalltable[kInd].name : fcalltable[kInd].name;
...
static void
show_os9timers(ushort mode, ulong active, ulong *call, ulong *num, int ticksLim)
{
    ushort  k, j, kInd;
    ulong   mxTicks, mxNum;
    st_typ *s;
...
ulong show_timing(ushort mode, int ticksLim, Boolean doDisable)
{
    ...
    if (active == 0)
        active = 1; /* prevent division by zero */
    ...
    if (!logtiming)
        timerstart = now + 1; /* prevent uninitialized <timerstart> */
    if (now < timerstart)
        now = timerstart;

    realtime = (now - timerstart) * TICKS_PER_SEC; /* avoid lost ticks */
    if (realtime < active)
        realtime = active; /* avoid negative lost ticks */
...
static void usage(char *name, _pid_)
{
    ...
    upe_printf("Options:  -r          switch on timing measurement & reset "
               "counters\n");
    upe_printf("          -d          disable   timing measurement\n");
    upe_printf(
        "          -e          re-enable timing measurement (but no reset)\n");
    ...
    upe_printf("          -s          show I$xxx + F$xxx calls + OS-9 progs "
               "(same as -fio)\n");
    ...
    for (h = 1; h < argc; h++) {
        ...
        if (*p == '-') {
            ...
            while (*p != NUL) {
                ...
                case 't':
                    mode |= STIM_TICKAVAIL; /* >=1 ticks */

                    switch (p[1]) {
                    case '=':
                        if (sscanf(&p[2], "%d", &ticksLim) < 1)
                            ticksLim = 1;
                        p = p + strlen(p) - 1; /* skip rest */
                        break;
                    default:
