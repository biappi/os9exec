...
/*#define	CP2_DDIO		(1<<7)*/ /* don't disable data caching
                                                    when in I/O */

/* configuration module:  system configuration flags (_msysconf field) */

#define SC_NOTBLEXP                                                            \
    (1 << 0)                 /* system tables are not expanded automatically   \
                              */
...
error_code _os_datmod     _OP((_CONST char *,
                           u_int32,
                           u_int16 *,
                           u_int16 *,
                           u_int32,
...
error_code _os_load  _OP((_CONST char *,
                         mh_com **,
                         void **,
                         u_int32,
                         u_int16 *,
...
error_code _os_mkmodule _OP((_CONST char *,
                             u_int32,
                             u_int16 *,
                             u_int16 *,
                             u_int32,
...
error_code _os_tlink
    _OP((u_int32, _CONST char *, void **, mh_trap **, void *, u_int32));
