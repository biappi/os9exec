...
os9app_llm Ä {Output}os9llm_CodeRes.r {Output}os9llm_Library.lib
    

# Code Resource for use in PPC App
{Output}os9llm_CodeRes.r Ä {Output}os9llm_CodeRes.rsrc
    Derez {Output}os9llm_CodeRes.rsrc -only O9LM > {Targ}

{Output}os9llm_CodeRes.rsrc Ä "{ObjDir¥68k}os9_llm_ppc.a.o"
    Link ¶
        -rt O9LM=200 ¶
        -m OS9_LLM_ENTRY ¶
        -o {Targ} ¶
...
{Output}os9llm_Library.lib Ä "{ObjDir¥68K}os9_llm_68k.a.o"
    MWLink68k ¶
        -o {Targ} ¶
        -xm library ¶
        -model far ¶
...
# ASM files
"{ObjDir¥68k}os9_llm_ppc.a.o" Ä {os9exec}os9_llm_ppc.a
    Asm {os9exec}os9_llm_ppc.a -o {Targ} {AOptions}

"{ObjDir¥68k}os9_llm_68k.a.o" Ä {os9exec}os9_llm_68k.a
